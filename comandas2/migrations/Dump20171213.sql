CREATE DATABASE  IF NOT EXISTS `comandas2` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `comandas2`;
...
--
-- Table structure for table `user_aplicacion`
--

DROP TABLE IF EXISTS `user_aplicacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_aplicacion` (
  `user_id` int(11) NOT NULL,
  `aplicacion_id` int(11) NOT NULL,
  PRIMARY KEY (`aplicacion_id`,`user_id`),
  KEY `fk_usuarios_aplicacion_user1` (`user_id`),
  ...
  CONSTRAINT `fk_usuarios_aplicacion_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2017-12-13 19:16:51
