...
class CategoriasController extends Controller
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => Categorias::find()->where(['aplicacion_id'=>Yii::$app->session->get('aplicacion_id')]),
        ]);
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success','Categría creada correctamente');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success','Categría actualizada correctamente');
            return $this->redirect(['index']);
        } else {
